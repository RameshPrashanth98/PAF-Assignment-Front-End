...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1181129901ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=paf&table=userpowerusageinformation">`paf`.`userpowerusageinformation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=paf&table=bills">`paf`.`bills`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electricity&table=payment">`electricity`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electrogriddb&table=customer">`electrogriddb`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=paf&table=payment">`paf`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=items&table=items">`items`.`items`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="227b767e60743b7767425f624326622d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="electricity" targettable="payment">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `electricity`.`payment` ( `accountNo` INT NOT NULL ,  `customerName` VARCHAR(30) NOT NULL ,  `unitsConsumed` VARCHAR(30) NOT NULL ,  `chargeForUnits` VARCHAR(30) NOT NULL ,  `adjustments` VARCHAR(30) NOT NULL ,  `totalAmount` VARCHAR(30) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `payment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bills`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bills`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`userpowerusageinformation` () ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`userpowerusageinformation` ( `userName` VARCHAR NOT NULL ,  `address` VARCHAR NOT NULL ,  `noOfUnit` VARCHAR NOT NULL ,  `month` VARCHAR NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`userpowerusageinformation` ( `userName` VARCHAR(30) NOT NULL ,  `address` VARCHAR(30) NOT NULL ,  `noOfUnit` VARCHAR(30) NOT NULL ,  `month` VARCHAR(10) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userpowerusageinformation`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `userpowerusageinformation` (`userName`, `address`, `noOfUnit`, `month`) VALUES (&#039;aa&#039;, &#039;bb&#039;, &#039;cc&#039;, &#039;dd&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`userpowerusageinformation` ( `usageID` INT NOT NULL AUTO_INCREMENT ,  `userName` VARCHAR(20) NOT NULL ,  `address` VARCHAR(30) NOT NULL ,  `noOfUnit` VARCHAR(10) NOT NULL ,  `month` VARCHAR(10) NOT NULL ,    PRIMARY KEY  (`usageID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `userpowerusageinformation` (`usageID`, `userName`, `address`, `noOfUnit`, `month`) VALUES (&#039;2&#039;, &#039;aa&#039;, &#039;ss&#039;, &#039;dd&#039;, &#039;ff&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="userpowerusageinformation">
                            <div class="action_content">
